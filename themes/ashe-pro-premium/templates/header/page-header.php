...
if ( ashe_options('header_image_label') === true ) :
	...
	if ( ashe_options( 'header_image_parallax' ) === true ) {
		$header_image_attr = 'data-image="'. esc_url( $header_image ) .'"';
	} else {
		$header_image_attr = 'style="background-image:url('. esc_url( $header_image ) .');"';
	}

?>

<div class="entry-header" data-bg-type="<?php echo ashe_options( 'header_image_bg_type' ); ?>" <?php echo $header_image_attr; ?> data-video-mp4="<?php echo ashe_options( 'header_image_video_mp4' ); ?>" data-video-webm="<?php echo ashe_options( 'header_image_video_webm' ); ?>">
	...
	<div class="cvr-container">
		<div class="cvr-outer">
			...
			<div class="header-logo">
				...
				<?php if ( ashe_options( 'responsive_logo' ) !== '' ) : ?>
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php esc_attr( bloginfo('name') ); ?>" class="mobile-logo">
						<img src="<?php echo esc_url( ashe_options( 'responsive_logo' ) ); ?>" alt="<?php esc_attr( bloginfo('name') ); ?>">
					</a>
				<?php endif; ?>
	...
	<?php if ( ashe_options('header_image_logo') === true && ashe_options( 'header_image_bg_type' ) === 'image' ) : ?>
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php esc_attr( bloginfo('name') ); ?>" class="header-image-logo"></a>
	<?php endif ?>
