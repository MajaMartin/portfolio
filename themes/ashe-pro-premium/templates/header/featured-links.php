...
<div id="featured-links" class="<?php echo ashe_options( 'general_links_width' ) === 'boxed' ? ' boxed-wrapper': ''; ?> clear-fix">
	...
	<!-- Link 4 -->
	<?php if ( ashe_options( 'featured_links_image_4' ) !== '' && wp_get_attachment_url( ashe_options( 'featured_links_image_4' ) ) != false ): ?>
	<div class="featured-link">
	...
	<!-- Link 5 -->
	<?php if ( ashe_options( 'featured_links_image_5' ) !== '' && wp_get_attachment_url( ashe_options( 'featured_links_image_5' ) ) != false ): ?>
	<div class="featured-link">
	...
	<!-- Link 6 -->
	<?php if ( ashe_options( 'featured_links_image_6' ) !== '' && wp_get_attachment_url( ashe_options( 'featured_links_image_6' ) ) != false ): ?>
	<div class="featured-link">
		<img src="<?php echo esc_url( wp_get_attachment_url( ashe_options( 'featured_links_image_6' ) ) ); ?>" alt="Link 6">
		<a href="<?php echo esc_url( ashe_options( 'featured_links_url_6' ) ); ?>" target="<?php echo esc_attr($links_window); ?>">
			<div class="cv-outer">
				<div class="cv-inner">
					<h6><?php echo esc_attr( ashe_options( 'featured_links_title_6' ) ); ?></h6>
				</div>
			</div>
		</a>
	</div>
