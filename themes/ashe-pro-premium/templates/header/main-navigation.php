...
<div id="main-nav" class="clear-fix" data-fixed="<?php echo ashe_options( 'main_nav_fixed' ); ?>" data-mobile-fixed="<?php echo ashe_options( 'responsive_nav_fixed' ); ?>">
	...
	<div <?php echo ashe_options( 'general_header_width' ) === 'contained' ? 'class="boxed-wrapper"': ''; ?>>
		...
		<div class="main-nav-sidebar">
			<div>
			<?php if ( ashe_options( 'main_nav_sidebar_icon' ) === 'hamburger' ) : ?>
				<span></span>
				<span></span>
				<span></span>
			<?php else: ?>
				<i class="fas fa-<?php echo esc_attr( ashe_options( 'main_nav_sidebar_icon' ) ); ?>"></i>		
			<?php endif; ?>
			</div>
		</div>
		<?php endif; ?>
		...
		<span class="mobile-menu-btn">
			<div>
			<?php if ( ashe_options( 'responsive_menu_icon' ) === 'hamburger' ) : ?>
				<span></span>
				<span></span>
				<span></span>
			<?php else: ?>
				<i class="fas fa-<?php echo esc_attr( ashe_options( 'responsive_menu_icon' ) ); ?>"></i>		
			<?php endif; ?>
			</div>
		</span>
