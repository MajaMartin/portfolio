...
function ashe_freemius_add_custom_html()
{
    ...
    echo  '<em>If you are having Trouble getting a License Key, please <a href="https://wp-royal.com/contact/?ref=ashe-pro-backend-theme-license/" target="_blank">contact us.</a>' ;
    echo  '</div>' ;
    wp_enqueue_style(
        'ashe-freemius',
...
if ( !function_exists( 'ashe_post_sharing' ) ) {
	...
	<div class="post-share">
        ...
        if ( ashe_options( 'blog_page_show_google' ) ) {
            $google_src = 'https://plus.google.com/share?url=' . esc_url( get_the_permalink() );
            ?>
		<a class="googleplus-share" target="_blank" href="<?php 
