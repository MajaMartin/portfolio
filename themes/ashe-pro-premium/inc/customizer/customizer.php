...
*/
	...
	$boxed_width_style1 = array(
		'full' 		=> esc_html__( 'Full', 'ashe-pro' ),
		'contained' => esc_html__( 'Contained', 'ashe-pro' ),
		'boxed' 	=> esc_html__( 'Boxed', 'ashe-pro' ),
	);

	$boxed_width_style2 = array(
		'full' 		=> esc_html__( 'Full', 'ashe-pro' ),
		'boxed' 	=> esc_html__( 'Boxed', 'ashe-pro' ),
	);

	$boxed_width_style3 = array(
		'full' 		=> esc_html__( 'Full', 'ashe-pro' ),
		'boxed' 	=> esc_html__( 'Boxed', 'ashe-pro' ),
		'inner' 	=> esc_html__( 'Inner', 'ashe-pro' ),
	);

	// Header Width
	ashe_select_control( 'general', 'header_width', esc_html__( 'Header Width', 'ashe-pro' ), $boxed_width_style1, 'refresh', 25 );

	// Slider Width
	ashe_select_control( 'general', 'slider_width', esc_html__( 'Featured Slider Width', 'ashe-pro' ), $boxed_width_style3, 'refresh', 27 );

	// Featured Links Width
	ashe_select_control( 'general', 'links_width', esc_html__( 'Featured Links Width', 'ashe-pro' ), $boxed_width_style2, 'refresh', 28 );

	// Content Width
	ashe_select_control( 'general', 'content_width', esc_html__( 'Content Width', 'ashe-pro' ), $boxed_width_style2, 'refresh', 29 );

	// Single Content Width
	ashe_select_control( 'general', 'single_width', esc_html__( 'Single Content Width', 'ashe-pro' ), $boxed_width_style2, 'refresh', 31 );

	// Footer Width
	ashe_select_control( 'general', 'footer_width', esc_html__( 'Footer Width', 'ashe-pro' ), $boxed_width_style1, 'refresh', 33 );
...
*/
	...
	// Enable Header Logo
	ashe_checkbox_control( 'header_image', 'logo', esc_html__( 'Link Header to Homepage', 'ashe-pro' ), 'refresh', 21 );

	// Navigation
	ashe_checkbox_control( 'header_image', 'slider_navigation', esc_html__( 'Show Navigation Arrows', 'ashe-pro' ), 'refresh', 23 );
	
	// Pagination
	ashe_checkbox_control( 'header_image', 'slider_pagination', esc_html__( 'Show Pagination Dots', 'ashe-pro' ), 'refresh', 25 );
...
*/
	...
	$sidebar_icons = array(
		...
		'heart' 				 => 'Heart',
		'arrow-right' 			 => 'Arrow',
		'angle-double-right' 	 => 'Arrow Double',
		'arrow-alt-circle-right' => 'Arrow Circle',
	);

	// Select Sidebar Icon
	ashe_select_control( 'main_nav', 'sidebar_icon', esc_html__( 'Select Sidebar Icon', 'ashe-pro' ), $sidebar_icons, 'refresh', 17 );

	// Mini Logo
	ashe_image_control( 'main_nav', 'mini_logo', esc_html__( 'Logo Upload', 'ashe-pro' ), 'refresh', 19 );

	// Mini Logo Width
	ashe_number_absint_control( 'main_nav', 'mini_logo_width', esc_html__( 'Logo Width', 'ashe-pro' ), array( 'step' => '1' ), 'postMessage', 21 );
...
*/
	...
	$slider_source = array(
		'custom' => esc_html__( 'Custom', 'ashe-pro' ),
		'posts' => esc_html__( 'Posts', 'ashe-pro' ),
	);
	 
	// Source
	ashe_select_control( 'featured_slider', 'source', esc_html__( 'Source', 'ashe-pro' ), $slider_source, 'refresh', 2 );
	...
	$wp_customize->add_control( new Customizer_Repeater( $wp_customize, 'featured_slider_repeater', array(
		'label'   => esc_html__( 'Slider Item','ashe-pro') ,
	...
	// Display
	ashe_select_control( 'featured_slider', 'display', esc_html__( 'Display Posts', 'ashe-pro' ), $slider_display, 'refresh', 4 );
	...
	// Category
	ashe_select_control( 'featured_slider', 'category', esc_html__( 'Select Category', 'ashe-pro' ), $slider_cats, 'refresh', 5 );
	...
	// Order By
	ashe_select_control( 'featured_slider', 'orderby', esc_html__( 'Order by:', 'ashe-pro' ), $slider_orderby, 'refresh', 6 );
	...
	// Image Crop Width
	ashe_number_absint_control( 'featured_slider', 'crop_width', esc_html__( 'Image Crop Width', 'ashe-pro' ), array( 'step' => '10' ), 'postMessage', 17 );

	// Image Crop Height
	ashe_number_absint_control( 'featured_slider', 'crop_height', esc_html__( 'Image Crop Height', 'ashe-pro' ), array( 'step' => '10' ), 'postMessage', 19 );

	// Horizontal Gutter
	ashe_number_absint_control( 'featured_slider', 'gutter_horz', esc_html__( 'Horizontal Gutter', 'ashe-pro' ), array( 'step' => '1', 'min' => '0' ), 'postMessage', 21 );

	// Autoplay
	ashe_number_absint_control( 'featured_slider', 'autoplay', esc_html__( 'Autoplay', 'ashe-pro' ), array( 'step' => '500' ), 'refresh', 23 );
...
*/
	...
	// Horizontal Gutter
	ashe_checkbox_control( 'featured_links', 'gutter_horz', esc_html__( 'Gutter', 'ashe-pro' ), 'refresh', 6 );

	$featured_links_culumns = array( 'step' => '1', 'min' => '1', 'max' => '6' );

	// Columns
	ashe_number_absint_control( 'featured_links', 'columns', esc_html__( 'Columns', 'ashe-pro' ), $featured_links_culumns, 'refresh', 7 );
	...
	// Link #6 Title
	ashe_text_control( 'featured_links', 'title_6', esc_html__( 'Title', 'ashe-pro' ), 'postMessage', 39 );

	// Link #6 URL
	ashe_url_control( 'featured_links', 'url_6', esc_html__( 'URL', 'ashe-pro' ), 'refresh', 41 );

	// Link #6 Image
	ashe_image_crop_control( 'featured_links', 'image_6', esc_html__( 'Image', 'ashe-pro' ), 600, 340, 'refresh', 43 );
...
*/
	...
	$post_header_position = array(
		'above' => esc_html__( 'Above Media', 'ashe-pro' ),
		'below' => esc_html__( 'Below Media', 'ashe-pro' ),
	);

	// Position
	ashe_select_control( 'blog_page', 'post_header_position', esc_html__( 'Post Header Position', 'ashe-pro' ), $post_header_position, 'refresh', 22 );
	...
	ashe_checkbox_control( 'blog_page', 'show_author_description', esc_html__( 'Show Author Description', 'ashe-pro' ), 'refresh', 55 );
...
*/
	...
	ashe_checkbox_control( 'page_footer', 'show_scrolltop', esc_html__( 'Show Scroll-Top Button', 'ashe-pro' ), 'refresh', 7 );
...
*/
	...
	// Logo
	ashe_image_control( 'responsive', 'logo', esc_html__( 'Logo Upload', 'ashe-pro' ), 'refresh', 1 );

	// Fixed
	ashe_checkbox_control( 'responsive', 'nav_fixed', esc_html__( 'Fixed Navigation', 'ashe-pro' ), 'refresh', 3 );

	// Merge to Responsive Menu
	ashe_checkbox_control( 'main_nav', 'merge_menu', esc_html__( 'Merge Top and Main Menus', 'ashe-pro' ), 'refresh', 5 );

	// Mini Logo
	ashe_checkbox_control( 'responsive', 'mini_logo', esc_html__( 'Show Mini Logo', 'ashe' ), 'refresh', 7 );

	// Mini Logo Width
	ashe_number_absint_control( 'responsive', 'mini_logo_width', esc_html__( 'Mini Logo Width', 'ashe-pro' ), array( 'step' => '1' ), 'refresh', 9 );

	// Featured Slider
	ashe_checkbox_control( 'responsive', 'featured_slider', esc_html__( 'Show Featured Slider', 'ashe' ), 'refresh', 11 );

	// Featured Links
	ashe_checkbox_control( 'responsive', 'featured_links', esc_html__( 'Show Featured Links', 'ashe' ), 'refresh', 13 );

	// Related Posts
	ashe_checkbox_control( 'responsive', 'related_posts', esc_html__( 'Show Related Posts', 'ashe' ), 'refresh', 15 );

	// Mobile Menu Icons Array
	$mobile_menu_icons = array(
		'chevron-down' 			 => 'Arrow',
		'angle-double-down' 	 => 'Arrow Double',
		'arrow-alt-circle-down'  => 'Arrow Circle',
		'hamburger' 			 => 'Hamburger',
		'plus' 					 => 'Plus',
	);

	// Select Mobile Menu Icon
	ashe_select_control( 'responsive', 'menu_icon', esc_html__( 'Select Mobile Menu Icon', 'ashe-pro' ), $mobile_menu_icons, 'refresh', 18 );
...
function ashe_customize_preview_js() {
	wp_enqueue_script( 'ashe-customize-preview', get_theme_file_uri( '/inc/customizer/js/customize-preview.js' ), array( 'customize-preview' ), '3.5.4', true );
}
...
function ashe_panels_js() {
	wp_enqueue_style( 'customizer-ui-css', get_theme_file_uri( '/inc/customizer/css/customizer-ui.css' ), array(), '3.5.4' );
	wp_enqueue_script( 'ashe-customize-controls', get_theme_file_uri( '/inc/customizer/js/customize-controls.js' ), array(), '3.5.4', true );
